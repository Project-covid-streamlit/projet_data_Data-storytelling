...
with tab1:
    ...
    st.image("https://github.com/Project-covid-streamlit/projet_data_Data-storytelling/blob/alimou/Database/date_covid.png?raw=true",width=200)
    ...
    st.image("https://github.com/Project-covid-streamlit/projet_data_Data-storytelling/blob/alimou/Database/wuhan.png?raw=true", width=200)
    ...
    st.image("https://github.com/Project-covid-streamlit/projet_data_Data-storytelling/blob/alimou/Database/origine.png?raw=true", width=200)
...
with tab2:
    ...
    df_e=pd.read_csv("https://raw.githubusercontent.com/Project-covid-streamlit/projet_data_Data-storytelling/alimou/Database/EXPANSION%20DU%20COVID.csv")
    ...
    if st.button('Quel est le dernier pays à être affecté par le COVID 19 ?'):
        ...
        st.image("https://github.com/Project-covid-streamlit/projet_data_Data-storytelling/blob/alimou/Database/2023_01_05_07j_Kleki.png?raw=true",width=380)
    else:
        st.write('')
...
with tab3:
   ...
   df_c=pd.read_csv("https://raw.githubusercontent.com/Project-covid-streamlit/projet_data_Data-storytelling/alimou/Database/COVIDIIVACCINS.csv")
...
with tab4:
   ...
   df_u=pd.read_csv("https://raw.githubusercontent.com/Project-covid-streamlit/projet_data_Data-storytelling/alimou/Database/Les%20pays%20les%20plus%20touch%C3%A9s.csv")
